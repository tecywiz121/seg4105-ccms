...
DATABASES = {
    'default': {
        ...
        'NAME': p_join(BASE_DIR, 'development.db'), # Or path to database file if using sqlite3.
...
MEDIA_ROOT = p_join(BASE_DIR, 'media/')
...
STATIC_ROOT = p_join(BASE_DIR, 'static/')
...
SECRET_KEY = '+xv+#po=n%2fib^y!)f)z3xc-pci@#ak)lb_c(&amp;sn!8fz7*3(!'
...
# Load local settings from seperate file
try:
